    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-start lg:justify-center px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
        ...
        <div className="text-center mb-6 lg:mb-10 relative">
          ...
          <p className="font-mono text-xs sm:text-sm mb-1" style={{ color: 'var(--color-text-secondary)', opacity: 0.8 }}>
            Live adversarial browser-agent arena.
          </p>
          <p className="font-mono text-[11px] sm:text-xs mb-2" style={{ color: 'var(--color-text-secondary)', opacity: 0.55 }}>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="font-mono text-[10px] tracking-wider transition-all duration-200 hover:opacity-100"
            style={{ color: 'var(--color-attacker)', opacity: 0.7 }}
          >
            Learn more →
          </a>
        </div>
